            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        ...
                        /*Kamasylvia Tooth Fairy Cabin(1)*/
                        [
                            [-34.49, -60.02],
                            [-34.54, -60.19],
                            [-34.50, -60.28],
                        ...
                        /*Kamasylvia Tooth Fairy Cabin(2)*/
                        [
                            [-32.46, -59.90],
                            [-32.35, -59.87],
                            [-32.29, -60.05],
                        ...
                        /*Secret Cave(Bloody Monastery(west))*/
                        [
                            [7.60, -50.64],
                            [7.50, -50.73],
                            [7.53, -50.76],
                        ...
                        /*Central Guard Camp(secret cave)*/
                        [
                            [14.38, -47.75],
                            [14.36, -47.78],
                            [14.29, -47.77],
                        ...
                        /*Bloody Monastery(secret cave)*/
                        [
                            [11.72, -51.22],
                            [11.77, -51.25],
                            [11.79, -51.23]
                        ],
                        /*Serendia Shrine(secret cave)*/
                        [
                            [16.80, -50.79],
                            [16.83, -50.74],
                            [16.90, -50.75],
                        ...
                        /*Abyssal Zone of the Sycraia Underwater Ruins(1)*/
                        [
                            [24.40, -12.62],
                            [24.58, -12.62],
                            [24.50, -12.55],
                        ...
                        /*Abyssal Zone of the Sycraia Underwater Ruins(2)*/
                        [
                            [22.96, -11.96],
                            [22.88, -12.17],
                            [22.94, -12.29],
                        ...
                        /*Abyssal Zone of the Sycraia Underwater Ruins(3)*/
                        [
                            [23.41, -10.54],
                            [23.54, -10.58],
                            [23.54, -10.82],
            ...
            "geometry": {
                ...
                "coordinates": [
                    [
                        ...
                        /*Ancient Ruins Excavation Site(2)*/
                        [
                            [25.95, -41.64],
                            [25.96, -41.76],
                            [25.92, -41.80],
                        ...
                        /*Pilgrim's Sanctum: Sincerity(Dreaming Oasis)*/
                        [
                            [79.89, -41.89],
                            [79.87, -41.94],
                            [79.90, -41.98],
                        ...
                        /*Valencia City(north4)*/
                        [
                            [93.85, -25.62],
                            [93.94, -25.56],
                            [93.92, -25.62]
                        ],
                        /*Valencia City(north5)*/
                        [
                            [94.04, -25.52],
                            [94.04, -25.57],
                            [94.09, -25.64],
                        ...
                        /*Valencia City(north8)*/
                        [
                            [94.71, -25.21],
                            [94.71, -25.32],
                            [94.81, -25.24]
                        ],
                        /*Valencia City(north9)*/
                        [
                            [95.05, -24.67],
                            [95.05, -24.77],
                            [95.08, -24.78],
                        ...
                        /*Papua Crinea(Queekity Thumpity Moon Village)*/
                        [
                            [-41.50, -53.13],
                            [-41.60, -53.07],
                            [-41.48, -53.04],
                        ...
                        /*Acher Western Camp(west island)*/
                        [
                            [-40.46, -57.22],
                            [-40.43, -57.20],
                            [-40.57, -57.15],
                        ...
                        /*Canyon of Corruption(secret cave)*/
                        [
                            [26.20, -39.28],
                            [26.30, -39.34],
                            [26.19, -39.41],
...
for (var i = 0; i < markerCity.length; i++) {
    marker = new L.marker([markerCity[i][0], markerCity[i][1]], {
            icon: IconCity
        })
        .bindTooltip(markerCity[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "city-tooltip all-tooltip"
        })
        .addTo(City);
}
...
for (var i = 0; i < markerTown.length; i++) {
    marker = new L.marker([markerTown[i][0], markerTown[i][1]], {
            icon: IconTown
        })
        .bindTooltip(markerTown[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "town-tooltip all-tooltip"
        })
        .addTo(Town);
}
...
for (var i = 0; i < markerNode1.length; i++) {
    marker = new L.marker([markerNode1[i][0], markerNode1[i][1]], {
            icon: IconNode1
        })
        .bindTooltip(markerNode1[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
        .addTo(Node1);
}
...
for (var i = 0; i < markerNode2.length; i++) {
    marker = new L.marker([markerNode2[i][0], markerNode2[i][1]], {
            icon: IconNode2
        })
        .bindTooltip(markerNode2[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerNode3.length; i++) {
    marker = new L.marker([markerNode3[i][0], markerNode3[i][1]], {
            icon: IconNode3
        })
        .bindTooltip(markerNode3[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerNode4.length; i++) {
    marker = new L.marker([markerNode4[i][0], markerNode4[i][1]], {
            icon: IconNode4
        })
        .bindTooltip(markerNode4[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerIslandYShape.length; i++) {
    marker = new L.marker([markerIslandYShape[i][0], markerIslandYShape[i][1]], {
            icon: IconNode1Small
        })
        .bindTooltip(markerIslandYShape[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerIslandCircle.length; i++) {
    marker = new L.marker([markerIslandCircle[i][0], markerIslandCircle[i][1]], {
            icon: IconNode2Small
        })
        .bindTooltip(markerIslandCircle[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "node-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerHarbor.length; i++) {
    marker = new L.marker([markerHarbor[i][0], markerHarbor[i][1]], {
            icon: IconHarbor
        })
        .bindTooltip(markerHarbor[i][2], {
            permanent: true,
            direction: 'center',
            className: "npc-tooltip all-tooltip"
        })
        .addTo(Harbor);
}
...
for (var i = 0; i < markerImperialFishingDelivery.length; i++) {
    marker = new L.marker([markerImperialFishingDelivery[i][0], markerImperialFishingDelivery[i][1]], {
            icon: IconImperialFishingDelivery
        })
        .bindTooltip(markerImperialFishingDelivery[i][2], {
            permanent: true,
            direction: 'center',
            className: "npc-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerTradeManager.length; i++) {
    marker = new L.marker([markerTradeManager[i][0], markerTradeManager[i][1]], {
            icon: IconTradeManager
        })
        .bindTooltip(markerTradeManager[i][2], {
            permanent: true,
            direction: 'center',
            className: "npc-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerBarterer.length; i++) {
    marker = new L.marker([markerBarterer[i][0], markerBarterer[i][1]], {
            icon: IconBarterer
        })
        .bindTooltip(markerBarterer[i][2], {
            permanent: true,
            direction: 'center',
            className: "npc-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerBartererOcean.length; i++) {
    marker = new L.marker([markerBartererOcean[i][0], markerBartererOcean[i][1]], {
            icon: IconBartererOcean
        })
        .bindTooltip(markerBartererOcean[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "npc-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerSeaMonster.length; i++) {
    marker = new L.marker([markerSeaMonster[i][0], markerSeaMonster[i][1]], {
            icon: markerSeaMonster[i][4]
        })
        .bindTooltip(markerSeaMonster[i][langNum], {
            permanent: true,
            direction: 'center',
            className: "monster-tooltip all-tooltip"
        })
...
for (var i = 0; i < markerCoxPiratesShadowGhost.length; i++) {
    marker = new L.marker([markerCoxPiratesShadowGhost[i][0], markerCoxPiratesShadowGhost[i][1]], {
            icon: IconCoxPiratesShadowGhost
        })
        .closeTooltip('')
...
for (var i = 0; i < markerCargoShip.length; i++) {
    marker = new L.marker([markerCargoShip[i][0], markerCargoShip[i][1]], {
            icon: IconCargoShip
        })
        .closeTooltip('')
        .addTo(CargoShip);
...
for (var i = 0; i < markerDrunkSniper.length; i++) {
    marker = new L.marker([markerDrunkSniper[i][0], markerDrunkSniper[i][1]], {
            icon: IconDrunkSniper
        })
        .closeTooltip('')
        .addTo(DrunkSniper);
}
...
for (var i = 0; i < markerPirateFlag.length; i++) {
    marker = new L.marker([markerPirateFlag[i][0], markerPirateFlag[i][1]], {
            icon: IconPirateFlag
        })
        .closeTooltip('')
        .addTo(PirateFlag);
...
for (var i = 0; i < markerCoelacanth.length; i++) {
    marker = new L.marker([markerCoelacanth[i][0], markerCoelacanth[i][1]], {
            icon: IconCoelacanth
        })
...
for (var i = 0; i < markerGrunt.length; i++) {
    marker = new L.marker([markerGrunt[i][0], markerGrunt[i][1]], {
            icon: IconGrunt
        })
...
for (var i = 0; i < markerTuna.length; i++) {
    marker = new L.marker([markerTuna[i][0], markerTuna[i][1]], {
            icon: IconTuna
        })
...
for (var i = 0; i < markerGiantOctopus.length; i++) {
    marker = new L.marker([markerGiantOctopus[i][0], markerGiantOctopus[i][1]], {
            icon: IconGiantOctopus
        })
...
for (var i = 0; i < markerSpottedSeaBass.length; i++) {
    marker = new L.marker([markerSpottedSeaBass[i][0], markerSpottedSeaBass[i][1]], {
            icon: IconSpottedSeaBass
        })
...
for (var i = 0; i < markerTilefish.length; i++) {
    marker = new L.marker([markerTilefish[i][0], markerTilefish[i][1]], {
            icon: IconTilefish
        })
...
for (var i = 0; i < markerBlueGrouper.length; i++) {
    marker = new L.marker([markerBlueGrouper[i][0], markerBlueGrouper[i][1]], {
            icon: IconBlueGrouper
        })
...
for (var i = 0; i < markerPorgy.length; i++) {
    marker = new L.marker([markerPorgy[i][0], markerPorgy[i][1]], {
            icon: IconPorgy
        })
...
for (var i = 0; i < markerBlackPorgy.length; i++) {
    marker = new L.marker([markerBlackPorgy[i][0], markerBlackPorgy[i][1]], {
            icon: IconBlackPorgy
        })
...
for (var i = 0; i < markerSmokeyChromis.length; i++) {
    marker = new L.marker([markerSmokeyChromis[i][0], markerSmokeyChromis[i][1]], {
            icon: IconSmokeyChromis
        })
...
for (var i = 0; i < markerSeaBass.length; i++) {
    marker = new L.marker([markerSeaBass[i][0], markerSeaBass[i][1]], {
            icon: IconSeaBass
        })
...
for (var i = 0; i < markerNibbler.length; i++) {
    marker = new L.marker([markerNibbler[i][0], markerNibbler[i][1]], {
            icon: IconNibbler
        })
...
for (var i = 0; i < markerEyespotPuffer.length; i++) {
    marker = new L.marker([markerEyespotPuffer[i][0], markerEyespotPuffer[i][1]], {
            icon: IconEyespotPuffer
        })
...
L.polygon(UnknownAreaLeft, {
    color: '#646047',
    weight: 0,
    fillOpacity: 1
}).addTo(UnknownArea);
L.polygon(UnknownAreaRight, {
    color: '#f9daac',
    weight: 0,
    fillOpacity: 1
}).addTo(UnknownArea);
L.polygon(UnknownAreaBottom, {
    color: '#9b8d7a',
    weight: 0,
    fillOpacity: 1
}).addTo(UnknownArea);
...
var htmlData = [
    ...
    [18, 18, 'Please check out for latest informations in here.<br><b>Discord Channel</b> : <b><a href="https://discord.gg/xRBqjyQ" target="_blank">https://discord.gg/xRBqjyQ</a></b>',
        '최신 정보는 이곳에서 확인해 주세요.<br><b>Discord Channel</b> : <b><a href="https://discord.gg/xRBqjyQ" target="_blank">https://discord.gg/xRBqjyQ</a></b>'
    ],
];
...
var overlaysTree = {
    ...
    children: [
        ...
        {
            label: '<b>' + OTarray[12][langNum] + '</b><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[4][langNum] + '</div></span>',
            selectAllCheckbox: true,
            children: [{
                    label: OTarray[0] + 'City.png">' + OTarray[1] + '<span>' + OTarray[13][langNum] + '</span></span>',
                    layer: CityAndTown
                },
                {
                    label: OTarray[0] + 'Node1.png">' + OTarray[1] + '<span>' + OTarray[14][langNum] + '</span></span>',
                    layer: Node1
                },
                {
                    label: OTarray[0] + 'Node2.png">' + OTarray[1] + '<span>' + OTarray[15][langNum] + '</span></span>',
                    layer: Node2
                },
                {
                    label: OTarray[0] + 'Node3.png">' + OTarray[1] + '<span>' + OTarray[16][langNum] + '</span></span>',
                    layer: Node3
                },
                {
                    label: OTarray[0] + 'Node4.png">' + OTarray[1] + '<span>' + OTarray[17][langNum] + '</span></span>',
                    layer: Node4
                },
                {
                    label: OTarray[0] + 'Island.png">' + OTarray[1] + '<span>' + OTarray[18][langNum] + '<i style="margin-left:7px; color:#c3c3c3;">(' + OTarray[19][langNum] + ')</i></span></span>',
                    layer: Island
                },
            ]
        },
        ...
        {
            label: '<b>' + OTarray[20][langNum] + '</b><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[5][langNum] + '</div></span>',
            selectAllCheckbox: true,
            children: [{
                    label: OTarray[0] + 'IconFreshwater.png">' + OTarray[1] + '<span>' + OTarray[21][langNum] + '</span></span><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[6][langNum] + '</div></span>',
                    layer: Freshwater
                },
                {
                    label: OTarray[0] + 'IconSaltwater.png">' + OTarray[1] + '<span>' + OTarray[22][langNum] + '</span></span><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[7][langNum] + '</div></div></span>',
                    layer: Saltwater
                },
            ]
        },
...

        {
            label: '<b>' + OTarray[23][langNum] + '</b><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[8][langNum] + '<br>' +
                ...
                '</tr>' +
                '</tbody>' +
                '</table><br>' + OTarray[9][langNum] + '</div></div></span>',
            selectAllCheckbox: true,
            children: [{
                    label: OTarray[0] + 'seagull/Coelacanth.png">' + OTarray[1] + '<span>' + SeagullFishList[0][langNum] + '</span></span>',
                    layer: Coelacanth
                },

                {
                    label: '<b>' + OTarray[24][langNum] + '</b>',
                    selectAllCheckbox: true,
                    children: [{
                            label: OTarray[0] + 'seagull/Grunt.png">' + OTarray[1] + '<span>' + SeagullFishList[1][langNum] + '</span></span>',
                            layer: Grunt
                        },
                        {
                            label: OTarray[0] + 'seagull/BlackPorgy.png">' + OTarray[1] + '<span>' + SeagullFishList[8][langNum] + '</span></span>',
                            layer: BlackPorgy
                        },
                        {
                            label: OTarray[0] + 'seagull/Tuna.png">' + OTarray[1] + '<span>' + SeagullFishList[2][langNum] + '</span></span>',
                            layer: Tuna
                        },
                        {
                            label: OTarray[0] + 'seagull/SpottedSeaBass.png">' + OTarray[1] + '<span>' + SeagullFishList[4][langNum] + '</span></span>',
                            layer: SpottedSeaBass
                        },
                    ]
                },

                {
                    label: '<b>' + OTarray[25][langNum] + '</b>',
                    selectAllCheckbox: true,
                    children: [{
                            label: OTarray[0] + 'seagull/Porgy.png">' + OTarray[1] + '<span>' + SeagullFishList[7][langNum] + '</span></span>',
                            layer: Porgy
                        },
                        {
                            label: OTarray[0] + 'seagull/SmokeyChromis.png">' + OTarray[1] + '<span>' + SeagullFishList[9][langNum] + '</span></span>',
                            layer: SmokeyChromis
                        },
                        {
                            label: OTarray[0] + 'seagull/SeaBass.png">' + OTarray[1] + '<span>' + SeagullFishList[10][langNum] + '</span></span>',
                            layer: SeaBass
                        },
                        {
                            label: OTarray[0] + 'seagull/EyespotPuffer.png">' + OTarray[1] + '<span>' + SeagullFishList[12][langNum] + '</span></span>',
                            layer: EyespotPuffer
                        },
                    ]
                },
                ...
                {
                    label: '<b>' + OTarray[26][langNum] + '</b>',
                    selectAllCheckbox: true,
                    children: [{
                            label: OTarray[0] + 'seagull/Tilefish.png">' + OTarray[1] + '<span>' + SeagullFishList[5][langNum] + '</span></span>',
                            layer: Tilefish
                        },
                        {
                            label: OTarray[0] + 'seagull/BlueGrouper.png">' + OTarray[1] + '<span>' + SeagullFishList[6][langNum] + '</span></span>',
                            layer: BlueGrouper
                        },
                        {
                            label: OTarray[0] + 'seagull/GiantOctopus.png">' + OTarray[1] + '<span>' + SeagullFishList[3][langNum] + '</span></span>',
                            layer: GiantOctopus
                        },
                        {
                            label: OTarray[0] + 'seagull/Nibbler.png">' + OTarray[1] + '<span>' + SeagullFishList[11][langNum] + '</span></span>',
                            layer: Nibbler
                        },
                    ]
                },
...

        {
            ...
            selectAllCheckbox: true,
            children: [{
                    label: OTarray[0] + 'Barterer.png">' + OTarray[1] + '<span>' + OTarray[27][langNum] + '</span></span>',
                    layer: Barterer
                },
                {
                    label: OTarray[0] + 'BartererOcean.png">' + OTarray[1] + '<span>' + OTarray[28][langNum] + '</span></span><span id="MarkertooltipIcon">?<div class="MarkertooltipText"' + OTarray[10][langNum] + '</div></span>',
                    layer: BartererOcean
                },
                {
                    label: OTarray[0] + 'Harbor.png">' + OTarray[1] + '<span>' + OTarray[29][langNum] + '</span></span>',
                    layer: Harbor
                },
                {
                    label: OTarray[0] + 'ImperialFishingDelivery.png">' + OTarray[1] + '<span>' + OTarray[30][langNum] + '</span></span>',
                    layer: ImperialFishingDelivery
                },
                {
                    label: OTarray[0] + 'TradeManager.png">' + OTarray[1] + '<span>' + OTarray[31][langNum] + '</span></span>',
                    layer: TradeManager
                },
            ]
        },
        ...
        {
            label: '<b>' + OTarray[32][langNum] + '</b>',
            selectAllCheckbox: true,
            children: [{
                    label: OTarray[0] + 'SeaMonster.png">' + OTarray[1] + '<span>' + OTarray[33][langNum] + '</span></span>',
                    layer: SeaMonster
                },
                {
                    label: OTarray[0] + 'IconCoxPiratesShadowGhost.png">' + OTarray[1] + '<span>' + OTarray[34][langNum] + '</span></span>',
                    layer: CoxPiratesShadowGhost
                },
                {
                    label: OTarray[0] + 'CargoShip.png">' + OTarray[1] + '<span>' + OTarray[35][langNum] + '</span></span>',
                    layer: CargoShip
                },
                {
                    label: OTarray[0] + 'DrunkSniper.png">' + OTarray[1] + '<span>' + OTarray[36][langNum] + '</span></span>',
                    layer: DrunkSniper
                },
                {
                    label: OTarray[0] + 'PirateFlag.png">' + OTarray[1] + '<span>' + OTarray[37][langNum] + '</span></span>',
                    layer: PirateFlag
                },
            ]
        },
...
function advancedMode() {
    ...
    var DraggableMarker = L.marker([-5, 5], {
        draggable: true,
        icon: DraggableMarkerIcon
    }).bindPopup('Move the marker').addTo(map);
